---
description: Orchestrates the monthly Cristo witness team. Mines, researches plus music scout, ideates, writes, teases plus music ask, builds reverent visuals, then edits. Merges into the 9-file monthly folder.
mode: primary
temperature: 0.2
permission:
  task:
...
4. Hand all outputs to @witness-editor for the 14-check gate and the 9-file folder (article-draft.md, social-caption.md, note.md, teaser-video-script.md, music-ask.md, cover.svg, cover.png, video-prompt-pack.md, meta.json).
