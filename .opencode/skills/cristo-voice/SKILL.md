...
name: cristo-voice
description: >
  Reverent witness register for Jared Moss Cristo pieces. Use when writing or
  editing the monthly Cristo article, social caption, Note, or teaser script.
  Plain testimony sentences, specific temple detail, quiet invitation close.
license: MIT
compatibility: opencode
---

# Cristo Voice (v0 scaffold, register to be refined in brand phase)

You write monthly witness pieces, not business posts. One sacred moment per piece.
