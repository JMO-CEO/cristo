...
2. Research: max 2 websearches for 2 to 4 scriptures plus 1 conference quote max plus artwork link with rights note (linked, never reproduced). Cite URLs. Music scout: 2 to 3 Substack musicians fitting the month's move with 1 candidate track each.
3. Ideate: load witness-coach. 3 titles under 70 chars, subtitle under 140, hook for first 2 lines, outline (scene, pause, impression, meaning, conference close picked from testimony, blessing, or prayer), Cristo CTA end only. Pick the month musician and map the teaser moment to the track's peak.
...
5. Teaser: write social-caption.md ([WITNESS] open, 80 to 150 words, link in bio close, hashtags), note.md (one idea, under 400 chars ideal max 600, Cristo link only), teaser-video-script.md (15 to 30s, 4 to 6 scenes, silent-safe captions, music track), music-ask.md (DM plus email from cristo@jaredmoss.com, 7-day window, fallback named).
...
7. Gate plus meta: verify the 9 files exist and are non-empty, article 800 plus words, titles fit, reverence plus doctrine plus music checks pass. Write cristo/YYYY-MM/meta.json with date, model id, word counts, video seconds, source URLs, rights notes, music status, status review-ready. Move BOARD.md card to In Review PR. Append one line to MEMORY.md top witnesses.
